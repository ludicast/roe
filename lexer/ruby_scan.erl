...
-file("./ruby_scan.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     build_float (TokenChars, TokenLine) .

-compile({inline,yyaction_1/2}).
-file("./ruby_scan.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     build_integer (TokenChars, TokenLine) .

-compile({inline,yyaction_2/2}).
-file("./ruby_scan.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     build_identifier (TokenChars, TokenLine) .

-compile({inline,yyaction_3/1}).
-file("./ruby_scan.xrl", 12).
yyaction_3(TokenLine) ->
     { token, { eol, TokenLine } } .

-compile({inline,yyaction_4/0}).
-file("./ruby_scan.xrl", 13).
yyaction_4() ->
     skip_token .

-compile({inline,yyaction_5/1}).
-file("./ruby_scan.xrl", 15).
yyaction_5(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./ruby_scan.xrl", 16).
yyaction_6(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("./ruby_scan.xrl", 17).
yyaction_7(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("./ruby_scan.xrl", 18).
yyaction_8(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("./ruby_scan.xrl", 19).
yyaction_9(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("./ruby_scan.xrl", 20).
yyaction_10(TokenLine) ->
     { token, { '~', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("./ruby_scan.xrl", 21).
yyaction_11(TokenLine) ->
     { token, { '*', TokenLine } } .
